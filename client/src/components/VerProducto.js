            ...
            <div className="contenido">
                <div className="row-inline-2">
                    <div className="productImageContainer">
                        <img src={iconosFolder(producto.img)} alt="imagen producto"></img>
                    </div>
                    <div className="rowElementContainer">
                        <h3>{producto.nombre} x {producto.cantidad}</h3>
                        <div>
                            <p>
                                <b>precioRegular: ${producto.precioRegular}</b>
                            </p>
                            <p>
                                <b>precioAhora: ${producto.precioAhora}</b>
                            </p>
                            <p>
                                <b>precioPromedio: ${producto.precioPromedio}</b>
                            </p>
                        </div>
